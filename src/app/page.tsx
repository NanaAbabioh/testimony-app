...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative container mx-auto px-4 sm:px-6 text-center">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="max-w-4xl mx-auto mb-8 sm:mb-10 md:mb-12">
              <p className="text-lg sm:text-xl md:text-2xl text-white/90 mb-2 font-light italic leading-relaxed">
                "We will not hide these truths from our children;
              </p>
              <p className="text-lg sm:text-xl md:text-2xl text-white/90 mb-4 font-light italic leading-relaxed">
                we will tell the next generation about the glorious deeds of the Lord,<br />
                about his power and his mighty wonders"
              </p>
              <p className="text-base sm:text-lg text-white/80">— Psalms 78:4, NLT</p>
            </div>
      ...
      <section id="discover-testimonies-section" className="relative py-12 sm:py-16 md:py-20 overflow-hidden" style={{
        backgroundImage: `url('/hallelujah-bg.svg')`,
        backgroundColor: '#ffffff'
      }}>
        <div className="container mx-auto px-4 sm:px-6 text-center">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 bg-gradient-to-r from-[#1a1a2e] via-[#0f3460] to-[#16213e] bg-clip-text text-transparent drop-shadow-lg">
              Discover Testimonies
            </h2>
            
            <div className="space-y-2">
              <p className="text-lg sm:text-xl md:text-2xl text-gray-700 font-light italic">
                "Come and listen, all you who fear God,
              </p>
              <p className="text-lg sm:text-xl md:text-2xl text-gray-700 font-light italic mb-4">
                and I will tell you what he did for me."
              </p>
              <p className="text-base sm:text-lg text-gray-600">— Psalms 66:16, NLT</p>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-gray-900 text-white py-12 sm:py-16">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12 text-center md:text-left">
            <div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3 sm:gap-4 justify-center md:justify-start">
                ...
                <a
                  ...
                  className="bg-gray-700 hover:bg-gray-600 p-2.5 sm:p-3 rounded-lg transition-all group touch-manipulation"
                ...
                >
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 fill-[#25D366] group-hover:fill-white transition-colors" viewBox="0 0 24 24">
